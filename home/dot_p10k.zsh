# Generated by Powerlevel10k configuration wizard on 2024-10-19 at 22:08 EDT.
...
() {
  ...
  # Commented out so the segment stays visible after `asp <profile>` sets
  # AWS_PROFILE, instead of only while typing an aws/terraform/etc. command.
