...
2. **Consistent messaging** - Always use shared utilities for script output
3. **Platform wrapping** - Darwin scripts must use conditional templates
4. **Script ordering** - Machine-specific Brewfile (position 28) must always be last in the package management group (20-29)
