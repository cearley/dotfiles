# Spec: Template Portability

## Purpose

Defines conventions that ensure chezmoi template files render correctly across all machines and users. Templates must not contain hardcoded usernames, version-pinned paths, or invalid shell commands in any branch.
