...
- [x] 1.2 For each installed skill directory, classify as: direct match → skip; unmatched but wildcard present → wildcard-covered; unmatched and no wildcard → orphan
...
- [x] 2.4 Confirm `specstoryai/agent-skills -all` is recognized as a wildcard and suppresses orphan output for skills attributed to it
