...
- [x] 9.1 Stage all new/modified files: partial, rc files, `.chezmoi.toml.tmpl`, `.chezmoiignore.tmpl` (renamed), plist, activation script.
- [x] 9.2 Commit with a clear message referencing this change name.
- [x] 9.3 Push to remote.
